...
#[AsCommand(name: 'make:scope', description: 'Create a new scope class')]
class MakeScopeCommand extends BaseCommand
{
	...
	{
		$this
			->addArgument('name', InputArgument::REQUIRED, 'The name of the scope class');
	}
	...
	{
		$stub = $this->getStub();
		$namespace = $this->getModelNamespace() . '\\Scopes';
